...
function CreateProduct1(product_name, brand, reviews, price, rating) {
  // object to hold product details and methords
  let product = {
  ...
  // Method to increase price by a given amount
  product.increasePrice = function (amount) {
    this.price += amount;
    return this.price;
  };

  // Method to decrease price by a given amount
  product.decreasePrice = function (amount) {
    this.price -= amount;
    return this.price;
  };

  // Method to check if product is expensive
...
console.log(product1); // { product_name: 'Black Pure Cotton Formal Shirt', brand: 'Peter England Elite', reviews: 224, price: 1799, rating: '4.3', getPrice: [Function], increasePrice: [Function], decreasePrice: [Function], isExpensive: [Function] }
...
// Constructor function CreateProduct2
...
console.log(product2); // CreateProduct2 { product_name: 'Black Pure Cotton Formal Shirt', brand: 'Peter England Elite', reviews: 224, price: 1799, rating: '4.3' }
...
// Example invocation
let product3 = new CreateProduct3(
  "Black Pure Cotton Formal Shirt",
  "Peter England Elite",
  224,
  1799,
...
console.log(product3); // Output the product object
console.log(product3.getPrice()); // Output: 1799
console.log(product3.increasePrice(301)); // Output: 2100
console.log(product3.isExpensive()); // Output: true
console.log(product3.decreasePrice(1200)); // Output: 900
console.log(product3.isExpensive()); // Output: false
